...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to an Optical Bitcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and optical bitcoin: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your oBTC addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified oBTC addresses"));
    ...
    openAction->setStatusTip(tr("Open an oBTC: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible oBTC command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Optical Bitcoin network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
